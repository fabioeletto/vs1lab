...
class InMemoryGeoTagStore{
    ...
    updateGeoTag(id, {latitude, longitude, name, hashtag}) {
        ...
        if (latitude) updateGeotag.latitude = latitude;
        if (longitude) updateGeotag.longitude = longitude;
        if (name) updateGeotag.name = name;
        if (hashtag) updateGeotag.hashtag = hashtag;
    ...
    searchGeoTags(searchTerm) {
     ...
     /*
        ...
        entfernt sind. Es verwendet den Satz des Pythagoras, um die Entfernung zwischen jedem Geotag 
